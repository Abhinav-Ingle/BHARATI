...
//   // Guard State Objects (Does not include created_by here, we inject it on dispatch)
...
//   // Create Lifeguard (Assigning Admin Identity)
...
//         </div>
//         <button className="logout-btn" onClick={() => {setIsLoggedIn(false); setUsername(''); setPassword('');}}><LogOut size={20} /> LOGOUT</button>
//       </div>
...
//                                 {lifeguards.length === 0 && <div className="no-data">No lifeguards registered.</div>}
